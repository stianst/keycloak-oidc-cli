...
public class TokenManager {
    ...
    public TokenManager(OAuthRequest OAuthRequest, TokenCache tokenCache, OAuthClient client) {
    ...
    private boolean isValid(String token, TokenType tokenType, String requestedScope) {
        ...
        if (!Objects.equals(tokenCache.getIssuer(), OAuthRequest.getIssuer())) {
            return false;
        }
        if (!Objects.equals(tokenCache.getClientId(), OAuthRequest.getClientId())) {
            return false;
        }
